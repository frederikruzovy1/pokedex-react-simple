...
export default class Pokemon extends Component {
  ...
  async componentDidMount() {
    ...
    // Convert to lbs(pounds)
    const weight = Math.round((pokemonRes.data.weight * 0.220662 + 0.0001) * 100) / 100;
    ...
    //podla mna to malo ist dnu do awaitu, ale who knows
    this.setState({
      imageUrl,
      pokemonID,
      name,
